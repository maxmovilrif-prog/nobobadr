        ...
        <div className="grid md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li><a href="/presupuesto" className="hover:text-emerald-400 transition-colors">{t('landing.nav.calculate_price')}</a></li>
              <li><a href="/track" className="hover:text-emerald-400 transition-colors">{t('landing.nav.track_order')}</a></li>
              <li><a data-testid="footer-client-login" href="/auth" className="hover:text-emerald-400 transition-colors font-medium text-emerald-300">{t('landing.nav.customer_area')}</a></li>
              <li><a href="/privacy" className="hover:text-emerald-400 transition-colors">{t('footer.privacy')}</a></li>
